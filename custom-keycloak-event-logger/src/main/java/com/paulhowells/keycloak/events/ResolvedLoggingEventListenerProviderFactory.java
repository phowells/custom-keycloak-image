...
public class ResolvedLoggingEventListenerProviderFactory implements EventListenerProviderFactory {

    public static final String ID = "resolved-logging";
    ...
    public EventListenerProvider create(KeycloakSession session) {
        return new ResolvedLoggingEventListenerProvider(session, logger, successLevel, errorLevel, quotes, sanitize);
    }
