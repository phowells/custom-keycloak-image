...
public abstract class HttpAbstractResponseHandler<T extends HttpAbstractResponse> implements ResponseHandler<T> {
    private static final Logger logger = LoggerFactory.getLogger(HttpAbstractResponseHandler.class);
    ...
    protected abstract void setResponseBody(HttpAbstractResponse result, HttpResponse httpResponse) throws IOException;
